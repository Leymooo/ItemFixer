...
public class ItemFixer extends JavaPlugin implements Runnable {
	...
	public void onEnable() {
		b = false;
		if (setupItemFixer()) {
			Bukkit.getScheduler().runTaskTimerAsynchronously((Plugin)this, this, 6000L, 6000L);
	...
	private boolean setupItemFixer() {
		...
		if (version.equals("v1_9_R2")) {
			this.getServer().getPluginManager().registerEvents((Listener)new ru.xtime_1_9R2.XListener(), (Plugin)this);
			Bukkit.getScheduler().runTaskTimerAsynchronously((Plugin)this, (Runnable)new ru.xtime_1_9R2.Task5(), 20L, 20L);
			return true;
