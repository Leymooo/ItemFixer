...
public class Checks
{
    ...
    public static boolean checkAttributes(final ItemStack item) {
        ...
        if (craft != null && item.getType() != Material.AIR && item != null) {
            ...
            if (NBT.toString().contains("AttributeModifiers:") || NBT.toString().contains("Unbreakable:") || NBT.toString().contains("ClickEvent") || NBT.toString().contains("run_command") || NBT.toString().contains("CustomName:") || NBT.toString().contains("CustomPotionEffects:")) {
                return true;
            }
